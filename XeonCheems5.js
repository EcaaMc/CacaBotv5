...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store) => {
    try {
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6282228877291-1616169743@g.us","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
...
case 'apaitusewa': 
throw `SEWA BOT ADALAH BOT AKAN MASUK KE GRUP KAMU`
break
...
└┬────────────┈ ⳹
   ...
   └─────────────┈ ⳹`
            ...
            let buttons = [{ buttonId: 'command', buttonText: { displayText: 'List Menu📃' }, type: 1 },{ buttonId: 'sewabot', buttonText: { displayText: 'Sewa✅' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules🚫' }, type: 1 }]
            let buttonMessage = {
