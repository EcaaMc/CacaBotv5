...
case 'apaitusewa': 
throw `Sewa Bot Adalah Bot Akan Masuk Ke Group Kamu`
break

case 'pesan':
throw `Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi\n\nAtau langsung ke Kontak Owner wa.me//:+6282228877291`
break

case 'apaituprem':
throw `Premium Adalah Untuk Membuka Fitur Yang Terkunci
dan Harus untuk Premium`
break
 
case 'rules':
throw `INTINYA JANGAN SPAM BOT`
break
...
└┬────────────┈ ⳹
   ...
   └─────────────┈ ⳹`
            ...
            let buttons = [{ buttonId: 'command', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'sewabot', buttonText: { displayText: 'SewaBot' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules' }, type: 1 }]
            let buttonMessage = {
	...
	const sections = [{
								...
								"rows": [
										...
										},
									{
										...
										{
										"title": "🔖 APA ITU SEWA BOT?",
										"description": "",
										"rowId": `${prefix}apaitusewa`
									}
								]
							},
							{
